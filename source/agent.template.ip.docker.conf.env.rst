ip.docker.conf resource template
----
...
::
	...
	#  scopable:     True
	#
	#  desc:  The network base address. Used to delete the network route if
	#         del_net_route is set to true.
	#
	;network = 10.0.0.0
	...
	#  scopable:     True
	#
	#  desc:  The docker container resource id to plumb the ip into.
	#
