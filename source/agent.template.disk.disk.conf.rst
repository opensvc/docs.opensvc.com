...
::
	...
	#  scope order:     specific > generic
	#
	#  desc:  The size of the disk to provision.
	#
	;size = 15g
	...
	#  scope order:     specific > generic
	#
	#  desc:  The array to provision the disk from.
	#
	;array = xtremio-prod1
	...
	#  scope order:     specific > generic
	#
	#  desc:  The array disk group to provision the disk from.
	#
	;diskgroup = default
