sync.symsrdfs.conf resource template
----
...
::
	...
	#  scopable:     True
	#
	#  desc:  Id of the local symmetrix array hosting the symdg. This parameter is
	#         usually scoped to define different array ids for different nodes.
	#
	;symid = foo
	...
	#  scopable:     False
	#
	#  desc:  Name of the RDF group pairing the source and target devices.
	#
	;rdfg = foo
