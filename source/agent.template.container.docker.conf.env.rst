container.docker.conf resource template
----
...
::
	...
	#  scopable:     True
	#
	#  desc:  The ip:port at which the swarm manager listens. If swarm is not
	#         used, this parameter should not be used, in which case, the service-
	#         private dockerd is used through its unix socket.
	#
	;run_swarm = 1.2.3.4:2374
