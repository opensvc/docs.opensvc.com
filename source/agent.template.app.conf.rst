...
::
	...
	#         hosted in the <svcname>.d path. This script must accept as arg0 the
	#         activated actions word: start for start, stop for stop, status for
	#         check, info for info.
	#
	;script = foo
	...
	#  scope order:     specific > generic
	#
	#  desc:  true: execute '<script> start' on start action. false: do nothing on
	#         start action. <shlex expression>: execute the command on start.
	#
	;start = False
	...
	#  scope order:     specific > generic
	#
	#  desc:  true: execute '<script> stop' on stop action. false: do nothing on
	#         stop action. <shlex expression>: execute the command on stop action.
	#
	;stop = False
	...
	#  scope order:     specific > generic
	#
	#  desc:  true: execute '<script> status' on status evaluation. false: do
	#         nothing on status evaluation. <shlex expression>: execute the
	#         command on status evaluation.
	#
	;check = False
	...
	#  scope order:     specific > generic
	#
	#  desc:  true: execute '<script> info' on info action. false: do nothing on
	#         info action. <shlex expression>: execute the command on info action.
	#
	;info = False
