sync.btrfssnap.conf resource template
----
...
::
	...
	#         between multiple btrfs snapshot resources. A full snapshot name is
	...
	#  scopable:     True
	#
	#  desc:  A whitespace separated list of <label>:<subvol> to snapshot.
	#
	;subvol = svc1fs:data svc1fs:log
