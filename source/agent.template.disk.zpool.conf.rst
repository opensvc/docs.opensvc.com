...
::
	...
	#  scope order:     specific > generic
	#
	#  desc:  The zone name the zpool refers to. If set, the zpool is activated in
	#         the zone context.
	#
	;zone = foo
	...
	#  convert:         list
	#
	#  desc:  The vdev list, including optional parity keywords, as would be
