fs.directory.conf resource template
----
...
::
	...
	#  scopable:     True
	#
	#  desc:  The fullpath of the directory to create.
	#
	;path = foo
	...
	#  scopable:     True
	#
	#  desc:  The user that should be owner of the directory. Either in numeric or
	#         symbolic form.
	#
	;user = root
	...
	#  scopable:     True
	#
	#  desc:  The group that should be owner of the directory. Either in numeric
	#         or symbolic form.
	#
	;group = sys
	...
	#  scopable:     True
	#
	#  desc:  The permissions the directory should have. A string representing the
	#         octal permissions.
	#
	;perm = 1777
