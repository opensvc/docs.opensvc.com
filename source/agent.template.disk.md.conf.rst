...
::
	...
	#  required:        False
	#  provisioning:    False
	#  default:         <false if single-node or uuid is not scoped, true otherwise>
	#  inheritance:     leaf > head
	#  scope order:     specific > generic
	...
	#
	;shared = <false if single-node or uuid is not scoped, true otherwise>
