sync.zfssnap.conf resource template
----
...
::
	...
	#  scopable:     True
	#
	#  desc:  A name included in the snapshot name to avoid retention conflicts
	#         between multiple zfs snapshot resources. A full snapshot name is
	#         formatted as <subvol>.<name>.snap.<datetime>. Example:
	#         data.weekly.snap.2016-03-09.10:09:52
	#
	;name = weekly
	...
	#  scopable:     True
	#
	#  desc:  Set to true to snap recursively the datasets.
	#
	;recursive = True
	...
	#  scopable:     True
	#
	#  desc:  A whitespace separated list of datasets to snapshot.
	#
	...
	#  scopable:     True
	#
	#  desc:  The maximum number of snapshots to retain.
	#
	;keep = 3
